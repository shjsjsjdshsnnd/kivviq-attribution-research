  ...
  forbidden: [
    {
      ...
      severity: "error",
      from: {
        path: "^(src/(observation|operator|operator_safe|action_ontology|canonical_action|population|action_timing|action_translation|simulator_intervention|paid_media|pricing|promotion|shipping|merchandising|inventory|cro|lifecycle)(/|$)|src/index\\.ts$)",
      },
      to: {
    ...
    },
    {
      ...
      severity: "error",
      from: {
        path: "^src/(action_timing|population|canonical_action)(/|$)",
      },
      to: {
